...
CLI и десктопное окно для работы с `chat.deepseek.com` через сохранённую браузерную сессию. Кросс-платформенно — работает на macOS, Linux и Windows.

**Репозиторий:** [github.com/Staks-sor/free-deepseek-cli](https://github.com/Staks-sor/free-deepseek-cli)

⭐ **Если проект оказался полезен — поставь звезду на GitHub.** Это бесплатно, занимает секунду и сильно помогает: чем больше звёзд, тем больше людей увидит проект, тем больше шансов получить полезный фидбэк и улучшения.
